...
contract Bank {
    ...
    modifier isOwner() { require(owner == msg.sender, "you are not owner");
        _;
    }
    ...
    function buy(uint256 coinValue) public {
        ...
        require(coinBalance[owner]>=value,"You don't have enough coins!");
    ...
    function transferCoin(address to, uint256 coinValue) public {
        ...
        require(coinBalance[msg.sender]>=value,"Not enough coins!");
